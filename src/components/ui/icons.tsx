/** SVG icons — 24x24, stroke-width 2, consistent style. No emoji. */
...
export function WarehouseIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M2 20h20M6 12h4v8H6zM14 12h4v8h-4z" />
    </svg>
  );
}
...
const iconMap: Record<string, React.ComponentType<IconProps>> = {
  product: PackageIcon,
  customer: UserIcon,
  supplier: BuildingIcon,
  warehouse: WarehouseIcon,
  account: WalletIcon,
};

export function catalogIcon(entity: string): React.ComponentType<IconProps> {
  return iconMap[entity] ?? PackageIcon;
}
